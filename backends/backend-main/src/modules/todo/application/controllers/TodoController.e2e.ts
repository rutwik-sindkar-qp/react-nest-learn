...
describe('TodoController E2E Tests', () => {
  ...
  beforeEach(async (): Promise<void> => {
    ...
    _todoRepository = testApp.app.get<TodoRepository>(TodoRepository)
  ...
  describe('POST /todos', () => {
    it('should create a new todo', async (): Promise<void> => {
    ...
    it('should return 400 when body is empty', async (): Promise<void> => {
      const response = await request(testApp.app.getHttpServer())
        .post('/todos')
        .send({})
    ...
    it('should return 400 when title is empty', async (): Promise<void> => {
      const response = await request(testApp.app.getHttpServer())
        .post('/todos')
        .send({title: ''})
    ...
    it('should return 400 when title is not a string', async (): Promise<void> => {
      const response = await request(testApp.app.getHttpServer())
        .post('/todos')
        .send({title: 123})
    ...
    it('should return 400 when title length is less than 1', async (): Promise<void> => {
      const response = await request(testApp.app.getHttpServer())
        .post('/todos')
        .send({title: ''})
    ...
    it('should create todo when title length is 1', async (): Promise<void> => {
      const response = await request(testApp.app.getHttpServer())
        .post('/todos')
        .send({title: 'a'})
    ...
    it('should create todo when title length is 255', async (): Promise<void> => {
    ...
    it('should return 400 when title length exceeds 255', async (): Promise<void> => {
  ...
  describe('DELETE /todos/:id', () => {
    it('should delete a todo by id', async (): Promise<void> => {
    ...
    it('should return 400 for invalid id format', async (): Promise<void> => {
      const deleteResponse = await request(testApp.app.getHttpServer()).delete(
        '/todos/invalid-id',
      )
    ...
    it('should return 404 if todo already deleted', async (): Promise<void> => {
      ...
      expect(deleteAgainResponse.body.message).toBe(
  ...
  describe('PUT /todos/:id', () => {
    it('should update a todo by id', async (): Promise<void> => {
    ...
    it('should return 404 for non-existent todo', async (): Promise<void> => {
    ...
    it('should allow partial update', async (): Promise<void> => {
  ...
  describe('GET /todos Pagination Tests', () => {
    ...
    it('should return empty array when no todos exist', async (): Promise<void> => {
    ...
    it('should return first 10 todos for page=1', async (): Promise<void> => {
    ...
    it('should return next 10 todos for page=2', async (): Promise<void> => {
      await createTodos(25)
      const response = await request(testApp.app.getHttpServer()).get(
    ...
    it('should return remaining 5 todos on page=3', async (): Promise<void> => {
      await createTodos(25)
      const response = await request(testApp.app.getHttpServer()).get(
    ...
    it('should return empty array for page greater than total pages', async (): Promise<void> => {
    ...
    it('should default to page=1 when page is missing', async (): Promise<void> => {
      await createTodos(12)
      const response = await request(testApp.app.getHttpServer()).get(
        '/todos?limit=10',
      )
    ...
    it('should default to limit=10 when limit is missing', async (): Promise<void> => {
      await createTodos(25)
      const response = await request(testApp.app.getHttpServer()).get(
        '/todos?page=2',
      )
    ...
    it('should handle invalid (non-numeric) page parameter', async (): Promise<void> => {
      await createTodos(12)
      const response = await request(testApp.app.getHttpServer()).get(
    ...
    it('should handle invalid (non-numeric) limit parameter', async (): Promise<void> => {
      await createTodos(25)
      const response = await request(testApp.app.getHttpServer()).get(
    ...
    it('should return 400 if page is negative', async (): Promise<void> => {
      const response = await request(testApp.app.getHttpServer()).get(
        '/todos?page=-1&limit=10',
      )
      expect(response.status).toBe(400)
    ...
    it('should return 400 if limit is negative', async (): Promise<void> => {
      const response = await request(testApp.app.getHttpServer()).get(
    ...
    it('should return 400 if limit is zero', async (): Promise<void> => {
      const response = await request(testApp.app.getHttpServer()).get(
  ...
  describe('GET /todos/:id', () => {
    it('should return a todo by id', async (): Promise<void> => {
